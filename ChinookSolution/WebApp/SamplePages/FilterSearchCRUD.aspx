 ...
 <h1>Filter Search</h1>
    ...
    <div class="col-md-offset-1">
       ...
       <asp:DropDownList ID="EditAlbumArtistList" runat="server" 
        ...
        <asp:LinkButton ID="Remove" runat="server" CausesValidation="false" OnClick="Remove_Click" OnClientClick ="return confirm('are you sure wish to remove this album from the collection')">Remove</asp:LinkButton>
    </div>
